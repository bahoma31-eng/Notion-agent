...
الإصدار 2.1 — مع خطة تنفيذية 12 أسبوعاً وتوليد ذكي حسب الوقت واليوم.
"""
...
PLAN_START_DATE = datetime.datetime(2026, 4, 27)
...
def post_to_facebook(message: str) -> str:
    ...
    payload = {
        "message": message,
        "published": "true",           # ✅ ضروري لضمان النشر المباشر وليس Draft
